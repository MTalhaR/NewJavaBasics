...
import group12Project.Task11;
import replitTasks.Task110JavaMethods;
...
//    }
    ...
    public static void main(String[] args){
        Task110JavaMethods task = new Task110JavaMethods();
        task.methodOne("talha",5);

        task.methodOne("masiha",10);
    }
